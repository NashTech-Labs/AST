package com.knoldus.implicits.wrapper
...
object Test extends App{
  // This is the only implicit that needs to be imported for two-way conversions between wrapped and
...
//  /** This method takes a java.io.File and prints its lines.  We use it to demonstrate implicit views. */
  ...
  def test() {
    val currentDirectory = new java.io.File("src/main/resources")
